            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isRare ? 'bg-amber-400/20' : 'bg-tag-orange/10'
                )}
              >
                {card.generation_type === '3d' ? (
                  <Box className={cn('size-7', isRare ? 'text-amber-400' : 'text-tag-orange')} />
                ) : (
                  <Sparkles
                    className={cn('size-7', isRare ? 'text-amber-400' : 'text-tag-orange')}
                  />
                )}
              </div>
              ...
              <p
                className={cn(
                  ...
                  isRare ? 'text-amber-400' : 'text-tag-text'
                )}
              >
                {card.name}
              </p>
        ...
        {isSelected && (
          <motion.div
            ...
            className={cn(
              ...
              isRare ? 'bg-amber-400' : 'bg-tag-orange'
            )}
          >
